<footer class="footer">
	...
	<ul class="centery">
		<li class="centery-item">
			<h4>8 894 345-54-34</h4>
		</li>
		<li class="centery-item">
			<h4><a href="mailto:hello@sherlockgame.ru?subject=Hello">hello@sherlockgame.ru</a></h4>
		</li>
	</ul>
	<ul class="centery">
		<li class="centery-item">
	...
	<ul class="centery">
		<li class="centery-item">
			<small class="signature"><a href="http://madebyfork.ru/">Made by Fork</a></small>
		</li>
	</ul>
</footer>
